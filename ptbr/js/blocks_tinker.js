...
Blockly.Blocks.motor_action_turn_on = {
  category: 'Motor Action',
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(316);
...
Blockly.Blocks.motor_action_turn_off = {
  category: 'Motor Action',
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(316);
...
Blockly.Blocks.math_andor = {
  ...
  init: function() {
    ...
    input.appendField(new Blockly.FieldDropdown([["e", "and"], ["ou", "or"]]), "andor");
    this.setInputsInline(true);
    this.setOutput(true, Boolean);
