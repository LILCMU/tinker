...
Blockly.GogoCode.motor_action_turn_on = function() {
  var code = '<span class="c316">on</span> \n';
  return code;
};

Blockly.GogoCode.motor_action_turn_off = function() {
  var code = '<span class="c316">off</span> \n';
  return code;
};
